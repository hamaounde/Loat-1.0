    ...
    @csrf
        ...
        <div class="row">
            ...
            <div class="col-4 form-group">
                ...
                <input type="number" name="quantite" class="form-control" min="1" id="nbreVehicule" oninput="myFunction()">
            </div>
            <div class="col-4 form-group">
                <label for="exampleInputPassword1">Nombre du jour</label>
                <input type="number" name="jour" class="form-control" min="1" id="jour" oninput="myFunction()" >
            </div>
            <div class="col-4 form-group">
