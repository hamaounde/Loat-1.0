...
@section('content')
    ...
    <form class="" method="PUT" action="location/'{{$locations->id}})" enctype="multipart/form-data">
    @csrf
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-4 form-group">
                ...
                <input type="text" name="destination" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$locations->periodeFin}}">
            </div>
            <div class="col-4 form-group">
            ...
            <div class="col-4 form-group">
                ...
                <input type="date" name="periodeDebut" class="form-control" id="" value="<?php echo date('Y-m-d'); ?>">
            </div>
            <div class="col-4 form-group">
                <label for="periode fin">Pédiode fin</label>
                <input type="date" name="periodeFin" class="form-control" id="" value="<?php echo date('Y-m-d'); ?>">
            </div>
            <div class="col-4 form-group">
                <label for="exampleInputPassword1">Forfait</label>
                <input type="number" name="forfait" class="form-control" id="forfait" min="1" oninput="myFunction()">
            </div>
        </div>
        <div class="row">
